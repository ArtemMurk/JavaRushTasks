...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        for (Apartment rooms: apartments) {
            if (rooms instanceof Apt1Room){
                ((Apt1Room) rooms).clean1Room();
            }
            else if (rooms instanceof Apt2Room) {
            ((Apt2Room) rooms).clean2Rooms();
            }
            else if (rooms instanceof Apt3Room) {
                ((Apt3Room) rooms).clean3Rooms();
            }
