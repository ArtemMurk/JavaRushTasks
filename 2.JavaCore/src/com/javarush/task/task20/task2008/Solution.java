...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Object singl1 = ois.readObject();
      //  singl1 = Singleton.readResolve();

        Singleton singleton = (Singleton) singl1 ;
        ois.close();
        ...
        Object singl = ois2.readObject();
//        singl = Singleton.readResolve();
        Singleton singleton1 = (Singleton) singl ;
        ois2.close();
