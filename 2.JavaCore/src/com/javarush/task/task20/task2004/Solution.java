...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = new File("/home/artem/primer1.txt");
            ...
            System.out.println(classWithStatic.equals(loadedObject)+" "+ classWithStatic.hashCode()+" " + loadedObject.hashCode());
            outputStream.close();
            inputStream.close();
